...
_Initial cost often equals the tip of an iceberg, Image source: [Pixabay](https://pixabay.com/de/illustrations/eisberg-wasser-blau-ozean-eis-1421411/)_
...
_Build ETL pipeines in a browser with Data Factory, Image source: [Microsoft](https://learn.microsoft.com/de-de/azure/data-factory/concepts-data-flow-overview)_
...
_Write data pipelines in high-code with Bonobo, Image source: [Bonobo](https://www.bonobo-project.org/)_
